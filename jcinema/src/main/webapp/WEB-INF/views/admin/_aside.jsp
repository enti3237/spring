    ...
    <ul class="sideMenu">
        ...
        <li>
            ...
            <ol>
                ...
                <li><a href="/jcinema/admin/movie/schedule">영화상영 일정 등록</a></li>                                
            </ol>
        </li>
        <li>
        ...
        <li>
            ...
            <ol>
                <li><a href="#">티켓현황</a></li>
                <li><a href="/jcinema/admin/ticket/generate.html">티켓생성</a></li>                                
            </ol>
        </li>
        <li>
            ...
            <ol>
                ...
                <li><a href="/jcinema/admin/theater/register">영화관 등록</a></li>
                <li><a href="/jcinema/admin/theater/register-screen">상영관 등록</a></li>
            </ol>
        </li>
        <li>
