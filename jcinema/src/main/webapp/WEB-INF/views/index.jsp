...
<main>
    <div class="slider">
        <div>
            <ul>
                <li><img src="/jcinema/img/slider_banner_poster1.jpg" alt=""></li>
            </ul>
            <div class="box-office">
                <div class="top">
                    <img src="/jcinema/img/tit_boxoffice.png" alt="BOX OFFICE">
                    <span class="tab">
    ...
    <div class="poster">
        <article>
            <ul>
                <li><a href="#"><img src="/jcinema/img/poster_banner_img1.jpg" alt=""></a></li>
                <li><a href="#"><img src="/jcinema/img/poster_banner_img2.jpg" alt=""></a></li>
                <li><a href="#"><img src="/jcinema/img/poster_banner_img3.jpg" alt=""></a></li>
                <li><a href="#"><img src="/jcinema/img/poster_banner_img4.jpg" alt=""></a></li>
                <li><a href="#"><img src="/jcinema/img/poster_banner_img5.jpg" alt=""></a></li>
            </ul>
        </article>
    </div>
    <div class="sponsor">
        <article>
            <ul>
                <li><a href="#"><img src="/jcinema/img/sponsor_img1.jpg" alt=""></a></li>
                <li><a href="#"><img src="/jcinema/img/sponsor_img2.jpg" alt=""></a></li>
                <li><a href="#"><img src="/jcinema/img/sponsor_img3.jpg" alt=""></a></li>
                <li><a href="#"><img src="/jcinema/img/sponsor_img4.jpg" alt=""></a></li>
                <li><a href="#"><img src="/jcinema/img/sponsor_img5.jpg" alt=""></a></li>
                <li><a href="#"><img src="/jcinema/img/sponsor_img6.jpg" alt=""></a></li>
                <li><a href="#"><img src="/jcinema/img/sponsor_img7.jpg" alt=""></a></li>
                <li><a href="#"><img src="/jcinema/img/sponsor_img8.jpg" alt=""></a></li>
            </ul>
        </article>
    </div>
    <div class="event">
